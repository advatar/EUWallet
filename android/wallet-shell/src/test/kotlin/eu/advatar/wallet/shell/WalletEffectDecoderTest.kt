    ...
    fun decodesClosedScreenVocabulary() {
        val effects = WalletEffectDecoder.decodeCoreOutput(
            """[
                ...
                {"type":"render","screen":{"screen":"nfcReading","state":"reading"}},
                {"type":"render","screen":{"screen":"issuancePreparing","document":{"documentId":"pid-1","documentName":"National ID","issuerName":"Federal identity authority","format":"dcSdJwt","status":"preparing","portraitRequired":true}}},
                {"type":"render","screen":{"screen":"issuanceReady","document":{"documentId":"pid-1","documentName":"National ID","issuerName":"Federal identity authority","format":"dcSdJwt","status":"ready","portraitRequired":true}}},
                {"type":"render","screen":{"screen":"issuanceNeedsAttention","document":{"documentId":"pid-1","documentName":"National ID","issuerName":"Federal identity authority","format":"dcSdJwt","status":"needsAttention","portraitRequired":true},"recovery":"sessionInterrupted"}},
