...
public struct MRZScanner: UIViewControllerRepresentable {
    ...
    public func makeUIViewController(context _: Context) -> MRZScannerViewController {
        let controller = MRZScannerViewController()
        controller.onCapture = onCapture
        return controller
    }

    public func updateUIViewController(_: MRZScannerViewController, context _: Context) {}
}

public final class MRZScannerViewController: UIViewController,
    AVCaptureVideoDataOutputSampleBufferDelegate
{
    ...
    private let queue = DispatchQueue(label: "id.iproov.pidcapture.mrz-scan")
    ...
    public static func extractMrz(from rawLines: [String]) -> String? {
